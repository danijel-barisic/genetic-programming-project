...
# version of protein warriors where there is no opponent eating, only food eating
...
def game_intro(gameDisplay):
    ...
    while intro:
        ...
        if click[0] == 1:
            ...
            if (DISPLAY_WIDTH / 4) - 50 < mouse[0] < (DISPLAY_WIDTH / 4) + 120 and (DISPLAY_HEIGHT / 2) - 20 < mouse[
                1] < (DISPLAY_HEIGHT / 2) + 70:
                return "GP"
            elif (DISPLAY_WIDTH / 2) - 50 < mouse[0] < (DISPLAY_WIDTH / 2) + 120 and (DISPLAY_HEIGHT / 2) - 20 < mouse[
                1] < (DISPLAY_HEIGHT / 2) + 70:
                return "CGP"
            elif (3 * (DISPLAY_WIDTH / 4)) - 50 < mouse[0] < (3 * (DISPLAY_WIDTH / 4)) + 120 and (
                    DISPLAY_HEIGHT / 2) - 20 < mouse[1] < (DISPLAY_HEIGHT / 2) + 70:
                return "NN"
